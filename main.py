...
def home():
    ...
    if request.method == "POST":
        ...
        if create != False:
            ...
            return render_template("home.html",error="Room does bot exist!",code=code,name=name)
...
if __name__ == "__main__":
    ...
    if __name__ == "__main__":
    socketio.run(app, debug=True, host="0.0.0.0", port=5000, allow_unsafe_werkzeug=True) # for deployment
